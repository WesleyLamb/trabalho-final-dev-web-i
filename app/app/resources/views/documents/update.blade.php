...
<div style="display: flex; justify-content: center; width: 100%">
     <form action="{{route('documents.store')}}" style="width: 50%; height: auto; padding: 1rem; gap:1rem; border-radius:0.5rem; box-shadow: 0 0.3rem 0.5rem rgba(0,0,0,0.4);">
          ...
          <div class="form-group" style="width: 100%">
               ...
               <input type="text" class="form-control" id="authorName" placeholder="Nome completo do autor" value="variável com nome do autor" required>
          </div>
          <div class="form-group" style="width: 100%">
               <label for="validationCustom01">Nome do Co-autor (caso exista):</label>
               <input type="text" class="form-control" id="authorName" placeholder="Nome completo do co-autor" value="variável com nome do coautor">
          </div>
          <div class="form-group" style="width: 100%">
               <label for="validationCustom01">Nome do Orientador:</label>
               <input type="text" class="form-control" id="authorName" placeholder="Nome completo do orientador" value="variável com nome do orientador" required>
          </div>
          <div class="form-group">
               <label for="yearInput">Ano:  </label>
               <input type="number" id="yearInput" name="year" min="1950" max="2024" placeholder="YYYY" value="variável com o ano" required>
          </div>
          <div class="form-group">
               <label for="exampleFormControlTextarea1">Título:</label>
               <textarea class="form-control" id="titulo" rows="1" value="variável com nome do autor" required></textarea>
          </div>
          <div class="form-group">
